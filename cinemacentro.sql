...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-10-2025 a las 02:04:10
...
--
ALTER TABLE `proyeccion`
  ADD CONSTRAINT `proyeccion_ibfk_1` FOREIGN KEY (`titulo`) REFERENCES `pelicula` (`titulo`),
